...
class ModelProvider(output: FabricDataOutput) : FabricModelProvider(output) {
    override fun generateBlockStateModels(generator: BlockModelGenerators) {
        ...
        generator.family(HybridBlocksBlocks.CRACKED_MEDIUM_STONE_BRICKS.get()).generateFor(HybridBlocksFamilies.CRACKED_MEDIUM_STONE_BRICKS)
        generator.family(HybridBlocksBlocks.MIXED_STONE_BRICKS.get()).generateFor(HybridBlocksFamilies.MIXED_STONE_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_STONE_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_STONE_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_MIXED_STONE_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_MIXED_STONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_STONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_STONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_STONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_STONE_BRICKS)
        generator.family(HybridBlocksBlocks.STONE_SHINGLES.get()).generateFor(HybridBlocksFamilies.STONE_SHINGLES)
        generator.family(HybridBlocksBlocks.MIXED_STONE_SHINGLES.get()).generateFor(HybridBlocksFamilies.MIXED_STONE_SHINGLES)

        generator.family(HybridBlocksBlocks.CRACKED_MEDIUM_DEEPSLATE_BRICKS.get()).generateFor(HybridBlocksFamilies.CRACKED_MEDIUM_DEEPSLATE_BRICKS)
        generator.family(HybridBlocksBlocks.MIXED_DEEPSLATE_BRICKS.get()).generateFor(HybridBlocksFamilies.MIXED_DEEPSLATE_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_DEEPSLATE_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_DEEPSLATE_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_MIXED_DEEPSLATE_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_MIXED_DEEPSLATE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_DEEPSLATE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_DEEPSLATE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_DEEPSLATE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_DEEPSLATE_BRICKS)
        generator.family(HybridBlocksBlocks.DEEPSLATE_SHINGLES.get()).generateFor(HybridBlocksFamilies.DEEPSLATE_SHINGLES)
        generator.family(HybridBlocksBlocks.MIXED_DEEPSLATE_SHINGLES.get()).generateFor(HybridBlocksFamilies.MIXED_DEEPSLATE_SHINGLES)
        ...
        generator.family(HybridBlocksBlocks.MIXED_SCHIST_BRICKS.get()).generateFor(HybridBlocksFamilies.MIXED_SCHIST_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_SCHIST_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_SCHIST_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_MIXED_SCHIST_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_MIXED_SCHIST_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_SCHIST_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_SCHIST_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_SCHIST_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_SCHIST_BRICKS)
        generator.family(HybridBlocksBlocks.LARGE_MIXED_SCHIST_BRICKS.get()).generateFor(HybridBlocksFamilies.LARGE_MIXED_SCHIST_BRICKS)
        generator.family(HybridBlocksBlocks.SCHIST_SHINGLES.get()).generateFor(HybridBlocksFamilies.SCHIST_SHINGLES)
        generator.family(HybridBlocksBlocks.MIXED_SCHIST_SHINGLES.get()).generateFor(HybridBlocksFamilies.MIXED_SCHIST_SHINGLES)

        generator.family(HybridBlocksBlocks.MIXED_CHIMNEYSTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.MIXED_CHIMNEYSTONE_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_CHIMNEYSTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_CHIMNEYSTONE_BRICKS)
        generator.family(HybridBlocksBlocks.MEDIUM_MIXED_CHIMNEYSTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.MEDIUM_MIXED_CHIMNEYSTONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_CHIMNEYSTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_CHIMNEYSTONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_CHIMNEYSTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_CHIMNEYSTONE_BRICKS)
        generator.family(HybridBlocksBlocks.LARGE_MIXED_CHIMNEYSTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.LARGE_MIXED_CHIMNEYSTONE_BRICKS)
        ...
        generator.family(HybridBlocksBlocks.SMALL_RED_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_RED_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_RED_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_RED_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.LARGE_MIXED_RED_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.LARGE_MIXED_RED_BRINESTONE_BRICKS)
        ...
        generator.family(HybridBlocksBlocks.SMALL_ORANGE_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_ORANGE_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_ORANGE_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_ORANGE_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.LARGE_MIXED_ORANGE_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.LARGE_MIXED_ORANGE_BRINESTONE_BRICKS)
        ...
        generator.family(HybridBlocksBlocks.SMALL_YELLOW_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_YELLOW_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.SMALL_MIXED_YELLOW_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.SMALL_MIXED_YELLOW_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.LARGE_MIXED_YELLOW_BRINESTONE_BRICKS.get()).generateFor(HybridBlocksFamilies.LARGE_MIXED_YELLOW_BRINESTONE_BRICKS)
        generator.family(HybridBlocksBlocks.YELLOW_BRINESTONE_SHINGLES.get()).generateFor(HybridBlocksFamilies.YELLOW_BRINESTONE_SHINGLES)
        generator.family(HybridBlocksBlocks.MIXED_YELLOW_BRINESTONE_SHINGLES.get()).generateFor(HybridBlocksFamilies.MIXED_YELLOW_BRINESTONE_SHINGLES)
