...
class ModelProvider(output: FabricDataOutput) : FabricModelProvider(output) {
    override fun generateBlockStateModels(generator: BlockModelGenerators) {
        ...
        generator.family(HybridBlocksBlocks.WHITE_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.WHITE_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.ORANGE_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.ORANGE_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.MAGENTA_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.MAGENTA_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.LIGHT_BLUE_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.LIGHT_BLUE_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.YELLOW_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.YELLOW_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.LIME_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.LIME_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.PINK_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.PINK_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.GRAY_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.GRAY_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.LIGHT_GRAY_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.LIGHT_GRAY_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.CYAN_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.CYAN_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.PURPLE_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.PURPLE_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.BLUE_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.BLUE_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.BROWN_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.BROWN_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.GREEN_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.GREEN_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.RED_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.RED_QUARTZ_TILES)
        generator.family(HybridBlocksBlocks.BLACK_QUARTZ_TILES.get())
            .generateFor(HybridBlocksFamilies.BLACK_QUARTZ_TILES)
