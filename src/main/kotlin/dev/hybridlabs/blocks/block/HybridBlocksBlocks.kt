...
object HybridBlocksBlocks {
    ...
    val WHITE_STAINED_BASKETWEAVE_BRICKS = register("white_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.WHITE)))
    val ORANGE_STAINED_BASKETWEAVE_BRICKS = register("orange_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.ORANGE)))
    val MAGENTA_STAINED_BASKETWEAVE_BRICKS = register("magenta_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.MAGENTA)))
    val LIGHT_BLUE_STAINED_BASKETWEAVE_BRICKS = register("light_blue_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.LIGHT_BLUE)))
    val YELLOW_STAINED_BASKETWEAVE_BRICKS = register("yellow_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.YELLOW)))
    val LIME_STAINED_BASKETWEAVE_BRICKS = register("lime_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.LIME)))
    val PINK_STAINED_BASKETWEAVE_BRICKS = register("pink_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.PINK)))
    val GRAY_STAINED_BASKETWEAVE_BRICKS = register("gray_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.GRAY)))
    val LIGHT_GRAY_STAINED_BASKETWEAVE_BRICKS = register("light_gray_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.LIGHT_GRAY)))
    val CYAN_STAINED_BASKETWEAVE_BRICKS = register("cyan_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.CYAN)))
    val PURPLE_STAINED_BASKETWEAVE_BRICKS = register("purple_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.PURPLE)))
    val BLUE_STAINED_BASKETWEAVE_BRICKS = register("blue_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.BLUE)))
    val BROWN_STAINED_BASKETWEAVE_BRICKS = register("brown_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.BROWN)))
    val GREEN_STAINED_BASKETWEAVE_BRICKS = register("green_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.GREEN)))
    val RED_STAINED_BASKETWEAVE_BRICKS = register("red_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.RED)))
    val BLACK_STAINED_BASKETWEAVE_BRICKS = register("black_stained_basketweave_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.BLACK)))

    val WHITE_STAINED_PINWHEEL_BRICKS = register("white_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.WHITE)))
    val ORANGE_STAINED_PINWHEEL_BRICKS = register("orange_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.ORANGE)))
    val MAGENTA_STAINED_PINWHEEL_BRICKS = register("magenta_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.MAGENTA)))
    val LIGHT_BLUE_STAINED_PINWHEEL_BRICKS = register("light_blue_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.LIGHT_BLUE)))
    val YELLOW_STAINED_PINWHEEL_BRICKS = register("yellow_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.YELLOW)))
    val LIME_STAINED_PINWHEEL_BRICKS = register("lime_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.LIME)))
    val PINK_STAINED_PINWHEEL_BRICKS = register("pink_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.PINK)))
    val GRAY_STAINED_PINWHEEL_BRICKS = register("gray_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.GRAY)))
    val LIGHT_GRAY_STAINED_PINWHEEL_BRICKS = register("light_gray_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.LIGHT_GRAY)))
    val CYAN_STAINED_PINWHEEL_BRICKS = register("cyan_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.CYAN)))
    val PURPLE_STAINED_PINWHEEL_BRICKS = register("purple_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.PURPLE)))
    val BLUE_STAINED_PINWHEEL_BRICKS = register("blue_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.BLUE)))
    val BROWN_STAINED_PINWHEEL_BRICKS = register("brown_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.BROWN)))
    val GREEN_STAINED_PINWHEEL_BRICKS = register("green_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.GREEN)))
    val RED_STAINED_PINWHEEL_BRICKS = register("red_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.RED)))
    val BLACK_STAINED_PINWHEEL_BRICKS = register("black_stained_pinwheel_bricks", Block(FabricBlockSettings.copy(Blocks.BRICKS).mapColor(DyeColor.BLACK)))
