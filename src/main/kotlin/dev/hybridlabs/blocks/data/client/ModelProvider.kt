...
class ModelProvider(output: FabricDataOutput) : FabricModelProvider(output) {
    override fun generateBlockStateModels(generator: BlockStateModelGenerator) {
        ...
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.WHITE_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.WHITE_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.ORANGE_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.ORANGE_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.MAGENTA_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.MAGENTA_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.LIGHT_BLUE_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.LIGHT_BLUE_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.YELLOW_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.YELLOW_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.LIME_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.LIME_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.PINK_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.PINK_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.GRAY_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.GRAY_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.LIGHT_GRAY_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.LIGHT_GRAY_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.CYAN_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.CYAN_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.PURPLE_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.PURPLE_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.BLUE_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.BLUE_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.BROWN_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.BROWN_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.GREEN_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.GREEN_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.RED_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.RED_SMOOTH_QUARTZ)
        generator.registerCubeAllModelTexturePool(HybridBlocksBlocks.BLACK_SMOOTH_QUARTZ)
            .family(HybridBlocksFamilies.BLACK_SMOOTH_QUARTZ)
    }
