...
class RecipeProvider(output: FabricDataOutput) : FabricRecipeProvider(output) {
    override fun generate(exporter: Consumer<RecipeJsonProvider>) {
        ...
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_BLACK_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_BLACK_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_BLUE_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_BLUE_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_BROWN_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_BROWN_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_CYAN_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_CYAN_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_GRAY_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_GRAY_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_GREEN_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_GREEN_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_LIGHT_BLUE_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_LIGHT_BLUE_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_LIGHT_GRAY_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_LIGHT_GRAY_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_LIME_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_LIME_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_MAGENTA_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_MAGENTA_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_ORANGE_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_ORANGE_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_PINK_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_PINK_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_PURPLE_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_PURPLE_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_RED_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_RED_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_WHITE_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_WHITE_QUARTZ_BLOCK)
        offerChiseledBlockRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CHISELED_YELLOW_QUARTZ_BLOCK, HybridBlocksBlocks.CHISELED_YELLOW_QUARTZ_BLOCK)
