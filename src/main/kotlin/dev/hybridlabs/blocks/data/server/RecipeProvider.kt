...
class RecipeProvider(output: FabricDataOutput) : FabricRecipeProvider(output) {
    override fun generate(exporter: Consumer<RecipeJsonProvider>) {
        ...
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.BLACK_SMOOTH_QUARTZ, Items.BLACK_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.BLUE_SMOOTH_QUARTZ, Items.BLUE_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.BROWN_SMOOTH_QUARTZ, Items.BROWN_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.CYAN_SMOOTH_QUARTZ, Items.CYAN_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.GRAY_SMOOTH_QUARTZ, Items.GRAY_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.GREEN_SMOOTH_QUARTZ, Items.GREEN_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.LIGHT_BLUE_SMOOTH_QUARTZ, Items.LIGHT_BLUE_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.LIGHT_GRAY_SMOOTH_QUARTZ, Items.LIGHT_GRAY_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.LIME_SMOOTH_QUARTZ, Items.LIME_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.MAGENTA_SMOOTH_QUARTZ, Items.MAGENTA_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.ORANGE_SMOOTH_QUARTZ, Items.ORANGE_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.PINK_SMOOTH_QUARTZ, Items.PINK_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.PURPLE_SMOOTH_QUARTZ, Items.PURPLE_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.RED_SMOOTH_QUARTZ, Items.RED_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.WHITE_SMOOTH_QUARTZ, Items.WHITE_DYE)
        offerSmoothQuartzDyeingRecipe(exporter, HybridBlocksBlocks.YELLOW_SMOOTH_QUARTZ, Items.YELLOW_DYE)
