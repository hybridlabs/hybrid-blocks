...
class RecipeProvider(output: FabricDataOutput) : FabricRecipeProvider(output) {
    override fun generate(exporter: Consumer<RecipeJsonProvider>) {
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.BLACK_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.BLACK_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.BLUE_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.BLUE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.BROWN_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.BROWN_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CYAN_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.CYAN_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.GRAY_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.GRAY_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.GREEN_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.GREEN_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.LIGHT_BLUE_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.LIGHT_BLUE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.LIGHT_GRAY_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.LIGHT_GRAY_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.LIME_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.LIME_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.MAGENTA_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.MAGENTA_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.ORANGE_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.ORANGE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.PINK_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.PINK_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.PURPLE_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.PURPLE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.RED_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.RED_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.WHITE_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.WHITE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.YELLOW_STAINED_PINWHEEL_BRICKS, HybridBlocksBlocks.YELLOW_STAINED_BRICKS)

        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.BLACK_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.BLACK_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.BLUE_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.BLUE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.BROWN_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.BROWN_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.CYAN_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.CYAN_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.GRAY_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.GRAY_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.GREEN_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.GREEN_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.LIGHT_BLUE_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.LIGHT_BLUE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.LIGHT_GRAY_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.LIGHT_GRAY_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.LIME_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.LIME_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.MAGENTA_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.MAGENTA_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.ORANGE_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.ORANGE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.PINK_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.PINK_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.PURPLE_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.PURPLE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.RED_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.RED_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.WHITE_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.WHITE_STAINED_BRICKS)
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, HybridBlocksBlocks.YELLOW_STAINED_BASKETWEAVE_BRICKS, HybridBlocksBlocks.YELLOW_STAINED_BRICKS)
    }
